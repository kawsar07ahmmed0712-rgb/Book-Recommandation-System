        ...
        try:
            ...
            response = RecommendationConfig(
                ...
                book_pivot_serialized_objects=os.path.join(
                    serialized_objects_dir, "book_pivot.pkl"
                ),
                final_rating_serialized_objects=os.path.join(
                    serialized_objects_dir, "final_rating.pkl"
                ),
                book_names_serialized_objects=os.path.join(
                    serialized_objects_dir, "book_names.pkl"
                ),
            )
